...
/**
 * Autogenerated description for ImportConfigResponse class
 *
 ...
 */
final class ImportConfigResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ImportConfigResponseInterface::class;
