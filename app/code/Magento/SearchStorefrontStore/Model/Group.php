...
class Group extends \Magento\Framework\Model\AbstractExtensibleModel implements
    ...
    \Magento\SearchStorefrontStore\Api\Data\GroupInterface,
    \Magento\Framework\App\ScopeInterface
{
     ...
     *
     * @var \Magento\SearchStorefrontStore\Model\ResourceModel\Store\Collection[]
     */
    protected $_stores;
     ...
     * Group default store
     *
     * @var \Magento\SearchStorefrontStore\Model\Store
     */
    ...
    public function __construct(
        ...
        \Magento\SearchStorefrontStore\Model\ResourceModel\Store\CollectionFactory $storeListFactory,
        \Magento\SearchStorefrontStore\Model\StoreManagerInterface $storeManager,
    ...
    {
        $this->_init(\Magento\SearchStorefrontStore\Model\ResourceModel\Group::class);
    }
     ...
     * Set website stores
     *
     * @param \Magento\SearchStorefrontStore\Model\Store[] $stores
     * @return void
     */
     ...
     *
     * @return \Magento\SearchStorefrontStore\Model\ResourceModel\Store\Collection
     */
     ...
     *
     * @param string $locale
     * @return \Magento\SearchStorefrontStore\Model\Store|null
     */
    ...
    public function getStoresByLocale($locale)
    {
        ...
        foreach ($this->getStores() as $store) {
            /* @var $store \Magento\SearchStorefrontStore\Model\Store */
    ...
    public function beforeDelete()
    {
        $this->_configDataResource->clearScopeData(
            \Magento\SearchStorefrontStore\Model\ScopeInterface::SCOPE_STORES,
            $this->getStoreIds()
        );
    ...
    public function setExtensionAttributes(
        \Magento\SearchStorefrontStore\Api\Data\GroupExtensionInterface $extensionAttributes
    ) {
