...
class Attribute implements LayerBuilderInterface
{
    /**
     * @var string
     * @see \Magento\SearchStorefront\DataProvider\Product\LayeredNavigation\Category::CATEGORY_BUCKET
     */
    private const PRICE_BUCKET = 'price_bucket';

    /**
     * @var string
     * @see \Magento\SearchStorefront\DataProvider\Product\LayeredNavigation\Builder\Price::PRICE_BUCKET
     */
